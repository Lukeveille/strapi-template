...
function ListView({
  ...
  const downloadCSV = async () => {
    const search = '_sort=repName%3AASC&_start=0'
    ...
    const now = new Date();
    const options = {
      filename: `everie_contact_forms_${now.toString()}`,
      fieldSeparator: ',',
      quoteStrings: '"',
      decimalSeparator: '.',
      showLabels: true, 
    ...
    csvExporter.generateCsv(searchData)
  };
          ...
          {canRead && (
            <Wrapper>
              <div className="row" style={{ marginBottom: '5px' }}>
                ...
                <div className="col-8">
                  <button color="primary" style={btnStyle} onClick={downloadCSV}>Download .CSV</button>
                </div>
                <div className="col-2">
